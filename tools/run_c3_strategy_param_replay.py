...
RUN_DIR = LOG_DIR / f"c3_strategy_param_replay_{RUN_ID}"
LATEST_JSON = LOG_DIR / "c3_strategy_param_replay_latest.json"
LATEST_NATIVE_CSV = LOG_DIR / "c3_strategy_param_replay_native_latest.csv"
LATEST_ADAPTER_CSV = LOG_DIR / "c3_strategy_param_replay_adapter_latest.csv"
LATEST_REPAIR_CSV = LOG_DIR / "c3_strategy_param_replay_repair_latest.csv"
LATEST_SUMMARY_CSV = LOG_DIR / "c3_strategy_param_replay_summary_latest.csv"
LATEST_MD = LOG_DIR / "c3_strategy_param_replay_latest.md"

STATUS = "READ_ONLY_C3_STRATEGY_PARAM_REPLAY_NOT_OPERATIONAL"
...
def main() -> int:
    ...
    if native_run["returncode"] != 0:
        payload = {
            ...
            "status": "READ_ONLY_C3_STRATEGY_PARAM_REPLAY_FAILED",
    ...
    lines = [
        "# C3 strategy-param read-only replay wrapper",
        "",
        f"- status: `{STATUS}`",
        f"- run id: `{RUN_ID}`",
