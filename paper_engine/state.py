...
def _build_paper_engine_persist_kwargs(
    *,
    state: Dict[str, Any],
    still_open: List[Dict[str, Any]],
    next_seq: int,
    ...
    candidate_df: pd.DataFrame,
    entry_decisions: Any,
    surge_inject_status: Dict[str, Any],
    entry_ready_count: int,
    no_next_day_count: int,
    open_order_replay_used_count: int,
    replay_regen_result: Dict[str, Any],
    ...
    return {
        ...
        "fills_new": fills_new,
        "trades_new": trades_new,
        "initial_open_count": int(initial_open_count),
        "replay_recovery_summary": replay_recovery_summary,
