...
if exist "%ROOT%paper\fills.csv" (
  ...
  "%PY%" tools\derive_d_from_fills.py --csv "%ROOT%paper\fills.csv" 1>"%D_FILLS_TMP%" 2>nul
...
if exist "%ROOT%paper\fills.csv" (
  ...
  "%PY%" tools\derive_d_from_fills.py --csv "%ROOT%paper\fills.csv" 1>"%D_RULE_TMP%" 2>nul
