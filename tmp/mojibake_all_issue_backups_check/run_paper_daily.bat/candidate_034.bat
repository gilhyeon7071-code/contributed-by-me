...
"%PY%" live_vs_bt_paper_daily.py --date %D% --auto-optimize --align-window-trades 30 --min-shared-trades 10 --max-backtest-age-days 7 --min-oos-trades 20 --min-oos-pf 0.75 --min-stable-score 0
if errorlevel 1 (
