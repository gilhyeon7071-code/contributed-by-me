...
if exist "%ROOT%paper\fills.csv" (
  for /f %%I in ('"%PY%" tools\derive_d_from_fills.py --csv "%ROOT%paper\fills.csv"') do set "D_FILLS=%%I"
)
...
set "D_RULE_FILLS="
if exist "%ROOT%paper\fills.csv" (
  for /f %%I in ('"%PY%" tools\derive_d_from_fills.py --csv "%ROOT%paper\fills.csv"') do set "D_RULE_FILLS=%%I"
)
