...
if exist "%ROOT%paper\fills.csv" (
  ...
  powershell -NoProfile -ExecutionPolicy Bypass -File "%ROOT%tools\derive_d_from_fills.ps1" -CsvPath "%ROOT%paper\fills.csv" 1>"%D_FILLS_TMP%" 2>nul
...
if exist "%ROOT%paper\fills.csv" (
  ...
  powershell -NoProfile -ExecutionPolicy Bypass -File "%ROOT%tools\derive_d_from_fills.ps1" -CsvPath "%ROOT%paper\fills.csv" 1>"%D_RULE_TMP%" 2>nul
