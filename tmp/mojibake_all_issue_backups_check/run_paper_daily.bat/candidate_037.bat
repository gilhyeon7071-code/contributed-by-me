...
if "%SSOT_HEALTH_CHECK%"=="" set "SSOT_HEALTH_CHECK=0"
...
if "%POST_CHAIN_FAILED%"=="1" (
  ...
  if "%POST_CHAIN_FAIL_SOFT%"=="1" (
    echo [WARN] POST_CHAIN_FAIL_SOFT=1 -> continue main success
    exit /b 0
  )
