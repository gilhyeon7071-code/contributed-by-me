...
target = r"""  call :POST_CHAIN_STEP_FAIL "[16.957e/16] build_recovery_ssot_chain_report.py"
)

REM [16.957f/16] final integrated ops snapshot after late post-chain writers"""

replacement = r"""  call :POST_CHAIN_STEP_FAIL "[16.957e/16] build_recovery_ssot_chain_report.py"
)
