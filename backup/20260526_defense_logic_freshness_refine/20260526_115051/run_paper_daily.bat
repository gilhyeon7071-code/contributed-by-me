...
if "%NEWS_LLM_SKIP%"=="" set "NEWS_LLM_SKIP=1"
echo [NEWS_LLM_GUARD] NEWS_LLM_SKIP=%NEWS_LLM_SKIP%
...
if errorlevel 1 (
  call :POST_CHAIN_STEP_FAIL "[16.93/16] build_recovery_ssot_chain_report.py"
)
