...
if "%KRX_UPDATE_CLEAN_TIMEOUT_SEC%"=="" set "KRX_UPDATE_CLEAN_TIMEOUT_SEC=600"
...
"%PY%" tools\run_future_signal_daily.py >> "%LAST_LOG%" 2>&1
set "RC=%ERRORLEVEL%"
...
if "%PAPER_DAILY_AFTER_CLOSE_LOG_CLEANUP_TIMEOUT_SEC%"=="" set "PAPER_DAILY_AFTER_CLOSE_LOG_CLEANUP_TIMEOUT_SEC=15"
