...
REM [2026-08-24] v41.1 신규 진입 정지. [7/9] paper_engine 도 이 경로를 탄다.
REM   근거: 진입 조건이 11.6년 / 12년 전부 음수 (.agent/PLANS.md 2026-08-24 (77)(84)).
REM   PAPER_EXIT_ONLY 는 paper_engine.py:440/448/1255/1388 의 정식 기능이고
REM   신규 진입만 막는다. 청산·손절·트레일과 데이터 갱신 단계는 그대로 돈다.
REM   되돌리려면 아래 한 줄을 지운다.
