...
if not defined PY if exist "C:\Users\jjtop\AppData\Local\Programs\Python\Python314\python.exe" set "PY=C:\Users\jjtop\AppData\Local\Programs\Python\Python314\python.exe"
if not defined PY if exist "C:\Users\jjtop\AppData\Local\Python\bin\python.exe" set "PY=C:\Users\jjtop\AppData\Local\Python\bin\python.exe"
if not defined PY (
