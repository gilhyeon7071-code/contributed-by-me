...
if "%SURGE_LOB_HOGA_MAX_FETCH%"=="" set "SURGE_LOB_HOGA_MAX_FETCH=7"
if "%SURGE_LOB_HOGA_SOFT_TIMEOUT_SEC%"=="" set "SURGE_LOB_HOGA_SOFT_TIMEOUT_SEC=20"
if "%SURGE_LOB_KIS_TIMEOUT_SEC%"=="" set "SURGE_LOB_KIS_TIMEOUT_SEC=3.5"
if "%SURGE_LOB_KIS_SLEEP_SEC%"=="" set "SURGE_LOB_KIS_SLEEP_SEC=0.80"
if "%SURGE_LOB_INGEST_TIMEOUT_SEC%"=="" set "SURGE_LOB_INGEST_TIMEOUT_SEC=35"
if "%SURGE_LOB_INGEST_TIMEOUT_CAP_SEC%"=="" set "SURGE_LOB_INGEST_TIMEOUT_CAP_SEC=35"
if "%INTRADAY_PRICE_TIMEOUT_SEC%"=="" set "INTRADAY_PRICE_TIMEOUT_SEC=240"
if "%INTRADAY_PRICE_MAX_TOTAL_CODES%"=="" set "INTRADAY_PRICE_MAX_TOTAL_CODES=85"
...
if "%WAIT_LOB_HOGA_MAX_FETCH%"=="" set "WAIT_LOB_HOGA_MAX_FETCH=20"
if "%WAIT_LOB_HOGA_SOFT_TIMEOUT_SEC%"=="" set "WAIT_LOB_HOGA_SOFT_TIMEOUT_SEC=40"
if "%WAIT_LOB_HOGA_SLEEP_SEC%"=="" set "WAIT_LOB_HOGA_SLEEP_SEC=0.35"
if "%WAIT_LOB_HOGA_OBSERVE_TIMEOUT_SEC%"=="" set "WAIT_LOB_HOGA_OBSERVE_TIMEOUT_SEC=70"
