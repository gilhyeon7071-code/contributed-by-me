...
REM [2026-08-24] v41.1 신규 진입 정지.
REM   근거: 진입 조건이 11.6년 / 12년 전부 음수 (.agent/PLANS.md 2026-08-24 (77)(84)).
REM   PAPER_EXIT_ONLY 는 paper_engine.py:440/448/1255/1388 에 이미 구현된 정식 기능이고,
REM   신규 진입만 막고 청산·손절·트레일은 그대로 둔다.
REM   여기에 두는 이유: 워치독(tools/intraday_loop_watchdog.ps1)도 이 bat 으로 루프를 되살리므로
REM   수동 재시작이든 워치독이든 같은 상태가 된다.
REM   되돌리려면 아래 한 줄을 지우고 루프를 재시작한다.
