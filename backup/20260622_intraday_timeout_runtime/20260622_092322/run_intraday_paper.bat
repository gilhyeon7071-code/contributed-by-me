...
if "%INTRADAY_PRICE_TIMEOUT_SEC%"=="" set "INTRADAY_PRICE_TIMEOUT_SEC=45"
if "%INTRADAY_PRICE_MAX_TOTAL_CODES%"=="" set "INTRADAY_PRICE_MAX_TOTAL_CODES=35"
...
if "%MARKET_RISING_TIMEOUT_CAP_SEC%"=="" set "MARKET_RISING_TIMEOUT_CAP_SEC=30"
if "%LOKY_MAX_CPU_COUNT%"=="" set "LOKY_MAX_CPU_COUNT=2"
if "%SURGE_ML_SCORE_TIMEOUT_SEC%"=="" set "SURGE_ML_SCORE_TIMEOUT_SEC=30"
