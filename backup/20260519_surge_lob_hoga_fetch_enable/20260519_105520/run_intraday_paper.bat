...
if "%SURGE_LOB_HOGA_MAX_FETCH%"=="" set "SURGE_LOB_HOGA_MAX_FETCH=0"
if "%SURGE_LOB_HOGA_SOFT_TIMEOUT_SEC%"=="" set "SURGE_LOB_HOGA_SOFT_TIMEOUT_SEC=12"
if "%SURGE_LOB_KIS_TIMEOUT_SEC%"=="" set "SURGE_LOB_KIS_TIMEOUT_SEC=2.5"
if "%SURGE_LOB_KIS_SLEEP_SEC%"=="" set "SURGE_LOB_KIS_SLEEP_SEC=0.50"
if "%SURGE_LOB_INGEST_TIMEOUT_SEC%"=="" set "SURGE_LOB_INGEST_TIMEOUT_SEC=20"
